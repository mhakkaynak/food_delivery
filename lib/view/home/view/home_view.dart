...
import 'package:food_delivery/view/home/view/search_result_view.dart';
              ...
              Expanded(
                child: BlocBuilder<HomeCubit, HomeState>(
                  builder: (context, state) {
                    return true // TODO: buradaki hata cozulecek
                        ? Column(
                            children: [
                              SearchBar(
                                  textStyle:
                                      context.currentTheme.textTheme.bodyText1,
                                  searchTextController: _searchTextController,
                                  onSubmitted: (String value) async {
                                    if (value.isNotEmpty)
                                      await context
                                          .read<HomeCubit>()
                                          .getFoodsInSearchResult(value);
                                  }),
                              Expanded(
                                // TODO: arama sayfasi burada olacak
                                child: CustomTabBar(
                                  ...
                                  tabColor:
                                      context.currentTheme.colorScheme.primary,
                                  changeIndex: context
                                      .read<HomeCubit>()
                                      .changeTabBarIndex,
                                ),
                                  ...
                                  itemBuilder: (context, index) => Row(
                                    children: [
                                      SizedBox(
                                        ...
                                        child: ProductCard(
                                          imagePath: state
                                              .foodList[index].imagePaths[0],
                                          foodName:
                                              state.foodList[index].foodName,
                                          foodPrice: state.foodList[index].price
                                              .toDouble(),
                                        ),
                                      ),
                                      SizedBox(
                        ...
                        : SearchResultView(foodList: state.foodList);
                  },
                ),
              ),
            ],
